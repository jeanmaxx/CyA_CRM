...
Ante un conflicto, descargar pendientes y cargar la versión guardada antes de volver a aplicar la corrección. No borrar los datos del navegador mientras existan cambios pendientes. La protección de servidor de la migración `20260909224224_require_transactional_saves.sql` está activa: las tablas operativas solo aceptan guardados mediante la operación transaccional del CRM. Una pestaña que conserve una versión anterior debe recargarse antes de intentar guardar.
